"""
Claude AI Integration - Geração de Pareceres Inteligentes
...
def gerar_parecer_agricultura(
    ...
    """
    Gera parecer executivo com IA para análise agrícola.
    """
...
def gerar_parecer_pecuaria(
    ...
    """
    Gera parecer executivo com IA para análise de pecuária.
    """
    modelo_id = _resolver_modelo(modelo)
    cliente = _get_cliente()
