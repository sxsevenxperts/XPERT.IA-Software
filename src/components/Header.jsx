...
const PAGE_TITLES = {
  ...
  portais:      { title: 'Portais Judiciais',     subtitle: 'Sincronize processos do TRF, INSS e CNJ' },
  ...
  analytics:    { title: 'Analytics & Previsões', subtitle: 'Previsões de receita, carga de trabalho e tendências com ML' },
